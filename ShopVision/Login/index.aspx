<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Unprotected.master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ShopVision.Login.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><br />
    ...
    <asp:Table ID="tblLoginform" runat="server" class="LoginFormContainer">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2"><img src="/Static/IMG/lock.png" /> <asp:Button ID="btnLogin" Runat="server" Text="Login" OnClick="btnLogin_Click"></asp:Button></asp:TableCell>
        </asp:TableRow>
    </asp:Table>         
    </div> 
</asp:Content>
